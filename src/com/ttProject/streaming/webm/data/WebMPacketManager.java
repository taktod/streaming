 ...
 * @author taktod
 */
public class WebMPacketManager {
	// ID list
...
/*	    // あとでしらべておきたいもの。file分割ストリームできる？
	...
	public WebMPacketManager() {
	}
	/**
	 * byteデータをいれればWebMPacketとして応答する。
	 */
	public void getPackets(byte[] data) {
		if(buffer != null) {
		...
		List<WebMPacket> result = new ArrayList<WebMPacket>();
